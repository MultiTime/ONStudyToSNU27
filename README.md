...
(수정) v14.3 🎈 배경 색 교체 + 오전 5:00 초기화 오류 Fix
배경 색을 기존의 옅은 색과 다르게 보색의 느낌이 나도록 강조하며 재배치. 오전 5:00에는 전날의 기록이 초기화되도록 하는 코드에 에러가 있었으나 이를 수정하고 배포한 버전

(2026.03.02. 수정) v15.0 🛠️✨ 배경 색 교체 + 렉 완벽 완화 완료
렉의 원인인 backdrop-filter의 blur 효과를 삭제하고 배경 색을 어두운 색상으로 취향에 맞게 업데이트한 버전. 비로소 이제서야 완성
